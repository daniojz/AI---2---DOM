...
var prueba1 = document.createElement("p");//<p></p>
prueba1.id = "prueba1" //<p id="parrafo1"></p>

var contenido = document.createTextNode("Hola Mundo!");//Hola Mundo!
prueba1.appendChild(contenido);//<p id="parrafo1">Hola Mundo!</p>
prueba1.classList
...
/* CHECKBOX EDAD */
    ...
    input="Tengo entre 18 y 30 años años";
    form_content.appendChild(input);    
    ...
    input="Tengo entre 30 y 40 años";
    form_content.appendChild(input);
...
/*CHECKBOX INFO MAIL */
    ...
    input.name="mail_si";
    input.value="mail_si";
    input="Si, acepto recibir información";
    form_content.appendChild(input);  
